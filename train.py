...
@click.option('--polyak_value', type=float, default=0.924, help='polyak averaging coefficient - Tau')
@click.option('--gamma_value', type=float, default=0.949, help='gamma - discounting factor')
...
@click.option('--random_epsilon', type=float, default=0.584, help='percentage of time a random action is taken')
@click.option('--noise_epsilon', type=float, default=0.232, help='std of gaussian noise added to not-completely-random actions as a percentage of max_u')
def main(**kwargs):
    launch(**kwargs)
